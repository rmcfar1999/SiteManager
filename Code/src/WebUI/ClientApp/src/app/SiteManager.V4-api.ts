...
export interface IAccountClient {
    login(login: LoginCommand): Observable<FileResponse>;
    register(register: RegisterCommand): Observable<number>;
    forgotPassword(register: ForgotPasswordCommand): Observable<boolean>;
}
...
export interface IRoleAdminClient {
    get(): Observable<AppRoleDto[]>;
    create(command: CreateRoleCommand): Observable<number>;
    update(command: UpdateRoleCommand): Observable<number>;
...
export class RoleAdminClient implements IRoleAdminClient {
    ...
    get(): Observable<AppRoleDto[]> {
        let url_ = this.baseUrl + "/api/RoleAdmin";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<AppRoleDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<AppRoleDto[]>><any>_observableThrow(response_);
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<AppRoleDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200!.push(AppRoleDto.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
        ...
        return _observableOf<AppRoleDto[]>(<any>null);
    }
    ...
    delete(id: number): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/RoleAdmin/{id}";
...
export interface IUserAdminClient {
    get(): Observable<AppUserDto[]>;
    create(command: CreateUserCommand): Observable<number>;
    update(command: UpdateUserCommand): Observable<number>;
    getByRole(id: number): Observable<AppUserDto[]>;
    delete(id: number): Observable<FileResponse>;
}
...
export class UserAdminClient implements IUserAdminClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    get(): Observable<AppUserDto[]> {
        let url_ = this.baseUrl + "/api/UserAdmin";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<AppUserDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<AppUserDto[]>><any>_observableThrow(response_);
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<AppUserDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(AppUserDto.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
        ...
        return _observableOf<AppUserDto[]>(<any>null);
    }
    ...
    getByRole(id: number): Observable<AppUserDto[]> {
        let url_ = this.baseUrl + "/api/UserAdmin/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetByRole(response: HttpResponseBase): Observable<AppUserDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class RegisterCommand implements IRegisterCommand {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.returnUrl = _data["returnUrl"];
            this.confirmationUrl = _data["confirmationUrl"];
        }
    }
...
export class ForgotPasswordCommand implements IForgotPasswordCommand {
    ...
    init(_data?: any) {
        if (_data) {
            this.email = _data["email"];
            this.passwordResetUrl = _data["passwordResetUrl"];
        }
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["email"] = this.email;
        data["passwordResetUrl"] = this.passwordResetUrl;
        return data; 
    }
}
...
export class AppUserDto implements IAppUserDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["appRoles"])) {
                this.appRoles = [] as any;
                for (let item of _data["appRoles"])
                    this.appRoles!.push(item);
            }
        }
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.appRoles)) {
            data["appRoles"] = [];
            for (let item of this.appRoles)
                data["appRoles"].push(item);
        }
        return data; 
    }
}
...
export class CreateUserCommand implements ICreateUserCommand {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.sendRegistrationConfirmation = _data["sendRegistrationConfirmation"];
            this.confirmationUrl = _data["confirmationUrl"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["sendRegistrationConfirmation"] = this.sendRegistrationConfirmation;
        data["confirmationUrl"] = this.confirmationUrl;
        return data; 
    }
}
