export const ApplicationName = 'SiteManager.V4.WebUI';
...
let applicationPaths: ApplicationPathsType = {
  ...
  LoginUI: `authentication/${LoginActions.LoginUI}`,
...
applicationPaths = {
  ...applicationPaths,
  LoginUIPathComponents: applicationPaths.LoginUI.split('/'),
...
interface ApplicationPathsType {
  ...
  readonly LoginUIPathComponents: string[];
